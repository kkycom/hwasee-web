...
// FB_AI_OPENINGS와 정확히 같은 순서/개수로 매칭되는 "이어쓰기 예시" — 씨앗 선택 직후
// 첫 문장 작성을 유도하는 인라인 입력창의 placeholder로 사용. 씨앗마다 톤에 맞는
// 문장이라야 자연스러워서, 고정 문구 하나가 아니라 씨앗별로 전부 따로 씀
// (2026-07-07, 초반 이탈률 개선 — [[project_hwasee_bang_state]] 참고)
const FB_AI_OPENING_HINTS = [
  "정류장엔 나 혼자 남아 있었다.",
  "날짜는 내일이었다.",
  "그런데 그 이름, 어디서 들어본 것 같았다.",
  "내비게이션은 계속 그쪽을 가리켰다.",
  "사진 뒷면엔 낯선 글씨로 내 이름이 적혀 있었다.",
  "매일 같은 시간, 같은 자리에서.",
  "내 번호로 전화를 걸어봤다.",
  "글씨체가 어딘가 낯익었다.",
  "동네 사람들은 아무도 이상하게 여기지 않았다.",
  "대출 기록에는 아무 이름도 없었다.",
  "다섯 번째 얼굴은 매번 조금씩 달랐다.",
  "열세 번째 칸은 늘 젖어 있었다.",
  "심지어 죽은 애 이름까지.",
  "손을 흔들자 그 사람도 똑같이 흔들었다.",
  "집안 문마다 다 꽂아봤지만 소용없었다.",
  "노인정 건물만 덩그러니 남아 있었다.",
  "그 사람은 슬픈 얼굴로 자리를 떴다.",
  "그들은 나를 보고 울면서 웃었다.",
  "그건 내 신발이 아니었다.",
  "그녀가 먼저 내 이름을 불렀다.",
  "돌아봤지만 아무도 없었다.",
  "장례식장 사진 속 얼굴도 둘 다 웃고 있었다.",
  "문틈으로 들여다보니 밥상은 텅 비어 있었다.",
  "아침에 일어나보니 낯선 아이 신발 한 켤레가 현관에 있었다.",
  "회전목마도 천천히 돌기 시작했다.",
  "알고 보니 오늘이 그 사람 생일이었다.",
  "그 번호로 전화해봤다.",
  "숟가락 개수는 언제나 방문객 수보다 하나 많았다.",
  "목소리가 평소보다 낮았다.",
  "그 요리, 내가 제일 좋아하던 거였다.",
  "물을 준 사람이 있는지 가족 모두에게 물어봤다.",
  "이력서를 뒤집어 보여줬다. 다른 사람 사진이 붙어 있었다.",
  "나는 그 사람 이름이 기억나지 않았다.",
  "다음 날 비가 그쳤는데도 계속 그 사람 생각이 났다.",
  "그 사람은 다음 날 이사를 간다고 했다.",
  "이번에도 그 사람이 먼저 커피를 내려줬다.",
  "사서는 그걸 아는 눈치였다.",
  "나는 잊고 싶은 걸 팔 수 있냐고 물었다.",
  "꽃집 주인은 마을에서 가장 부자였다.",
  "내 앞엔 빈 잔이 놓였다.",
  "칠판엔 아무도 안 지운 낙서가 남아 있었다.",
  "거울 속 내 얼굴만 조금 낯설었다.",
  "매년 그날이 되면 핸드폰을 만지작거렸다.",
  "짐을 다 빼고 나니 방이 낯설게 느껴졌다.",
  "그냥 우연이라기엔 너무 정확했다.",
  "마을 사람들은 그걸 소원이 아직 안 끝나서라고 했다.",
  "다들 그 이야기를 하다가 말끝을 흐렸다.",
  "다음 날도 그 사람은 같은 옷을 입고 있었다.",
  "그 시각이 되면 방이 조금 서늘해졌다.",
  "문은 항상 열려 있었다.",
  "우산 없이 그 골목에 들어선 적은 한 번도 없었다.",
  "선생님도 그 사실을 알면서 아무 말 하지 않았다.",
  "뒷자리엔 아직 누군가 앉아 있었다.",
  "어느 날부터는 아예 따라오지 않았다.",
  "요즘 들어 잎이 자주 떨어졌다.",
  "가족들은 반가움보다 낯섦을 먼저 느꼈다.",
  "그 방향엔 아무것도 없었다.",
  "사진 속 나는 오늘 입은 옷을 입고 있었다.",
  "발 크기는 어른 것이었다.",
  "우리는 벌써 넉 달째 살고 있었다.",
  "나오는 노래는 늘 옛날 노래였다.",
  "관리사무소엔 그런 직원이 없다고 했다.",
  "칠판엔 오늘 날짜가 적혀 있었다.",
  "나는 어떤 기억부터 팔지 한참을 고민했다.",
  "다들 같은 사람이 나오는 꿈을 꿨다.",
  "고장났다고 말했지만, 사실은 멀쩡했다.",
  "관제실은 그 꽃을 촬영하지 말라고 지시했다.",
  "가장 오래된 책이 맨 앞에 서 있었다.",
  "어부들은 그 소리로 날씨를 점쳤다.",
  "아이만 그 사실을 눈치채지 못했다.",
  "전부 같은 가게에서 받은 영수증이었다.",
  "말없이 두는 수마다 시간이 길었다.",
  "초는 내 나이보다 하나 더 꽂혀 있었다.",
  "쪽지엔 낯선 필체로 딱 한 문장이 적혀 있었다.",
  "돌아보니 아무도 없었다.",
  "대신 아무 말 없이 손수건을 건넸다.",
  "10년 만에 간 나를 보고도 이름을 먼저 불렀다.",
  "다들 숨죽이고 그 애 첫마디를 기다렸다.",
  "이번엔 손이 떨리지 않았다.",
  "그 말이 뭐였는지는 아직도 말 못 하겠다.",
  "왜 그런지는 나중에야 알았다.",
  "그날따라 자꾸 엄마 라면 생각이 났다.",
  "그래도 아무도 나를 모른다는 게 좋았다.",
  "상대는 잠깐 놀란 얼굴이었다.",
  "그래도 맛은 늘 똑같았다.",
  "결국 또 웃으면서 대답했다.",
  "선생님도 나한테 존댓말을 썼다.",
  ...
  "다른 집 앞은 전부 발자국투성이였다.",
  "손님은 항상 나 하나뿐이었다.",
  "몇 년을 옆집에 살면서도 몰랐던 이름이었다.",
  "다음 장엔 내일 날짜가 적혀 있었다.",
  "그 사람은 매일 마을 입구에서 누군가를 기다렸다.",
  "곡조는 매번 조금씩 달랐다.",
  "그게 제일 이상했다.",
  "메뉴판을 보는 척하며 눈을 피했다.",
  "그리고 내 것과 나란히 놓았다.",
  "나는 아무 말도 못 하고 전화를 끊었다.",
  "그러고는 둘 다 머쓱하게 서 있었다.",
  "거울을 보자마자 후회가 밀려왔다.",
  "직원이 세 번째로 카드를 다시 넣어봤다.",
  "엄마한테서 바로 답장이 왔다. '누구야 이 사람?'",
  "그제서야 잠이 확 깼다.",
  "밖에서 인기척이 나기만을 기다렸다.",
  "옆자리 사람이 웃음을 참고 있었다.",
  "박스에는 내 이름이 정확히 적혀 있었다.",
  "그다음 댓글은 더 심했다.",
  "결국 어색한 웃음만 지었다.",
  "엄마는 대체 어디서부터 알고 있던 걸까.",
  "일어나보니 정오였다.",
  "그마저도 배가 고파서 그만뒀다.",
  "잔고는 원래 자리로 돌아갔다.",
  "결국 그날 저녁도 같은 반찬이었다.",
  "다들 갑자기 조용해졌다.",
  "직원이 미안한 얼굴로 말했다. '여기 아니에요.'",
  "이름을 듣고도 전혀 기억나지 않았다.",
  "그마저도 주문을 취소했다.",
  "포장지보다 상자 안 내용물이 더 급했나 보다.",
  "엄마는 그냥 웃기만 했다.",
];
...
async function fbGetSeeds() {
  ...
  return { ok: true, seeds: picked.map(opening => ({ opening, hint: FB_OPENING_HINT_MAP.get(opening) || '' })) };
}
