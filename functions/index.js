...
// 시딩)와 같은 취지. 150개를 다 쓰면 config/word_challenge_seed_state.next_index로
// 처음부터 순환 재사용(하루짜리 가벼운 이벤트라 반복돼도 크게 문제 없음).
// 최초 50개(2026-07-01)가 일 단위로 소진되며 정확히 50일 만에 한 바퀴 돌아
// 2026-07-13 세트(코끼리/와이파이/도자기)가 2026-09-01에 그대로 재등장한 것을
// 유저가 알아챔 — 순환 주기를 늦추려고 100개를 추가함(2026-09-01). 새로
// 추가하는 세트는 기존 50개와 "3단어 조합" 기준으로 안 겹치게 스크립트로
// 검증 후 넣음(개별 단어 재사용은 기존 배열도 이미 허용하던 방식이라 유지).
const WORD_CHALLENGE_SEED_SETS = [
  ...
  ['기사','부채춤','보온병'], ['카멜레온','공작','대장장이'], ['딱따구리','열쇠고리','판다'],
  ['솔부엉이','전기밥솥','아지랑이'], ['만두찜기','두꺼비','도토리'], ['참외','폭포수','부채'],
  ['드래곤','전동휠','다듬이'], ['두부','다듬이','우박'], ['손전등','시루떡','빗자루'],
  ['전망대','백조','비버'], ['장구','지우개','연날리기'], ['메모지','우체국','불가사리'],
  ['자몽','펭귄','도시락'], ['약과','빨래집게','코뿔소'], ['대장장이','바늘','아지랑이'],
  ['달팽이','곤돌라','장갑'], ['썰매','투호','스테이플러'], ['늪지대','석류','서리'],
  ['폭풍우','여우','목도리'], ['피크닉바구니','약과','일식'], ['풍차','플라밍고','가재'],
  ['은행','빗자루','열쇠고리'], ['클립','장갑','백조'], ['석류','습지','컴퍼스'],
  ['고무줄놀이','전기밥솥','기린'], ['순록','지우개','자물쇠'], ['실타래','빙산','호떡'],
  ['짚신','여우','당근'], ['아지랑이','고구마','늪지대'], ['거인','고슴도치','전갈'],
  ['장갑','카멜레온','안전핀'], ['알람시계','재봉틀','달팽이'], ['거위','산양','로봇팔'],
  ['석류','열대우림','메모지'], ['물뿌리개','당근','동굴'], ['광부','만두찜기','고고학자'],
  ['드래곤','광부','약과'], ['절구','다듬이','제기'], ['절구','책갈피','부채춤'],
  ['은행','다리미','대장장이'], ['타조','전동휠','도시락'], ['요정','토네이도','강정'],
  ['옥수수','우체국','협곡'], ['가위','도롱이','비버'], ['증기기관차','두루미','당근'],
  ['증기기관차','바늘','우박'], ['산양','풍차','호루라기'], ['대장장이','외발자전거','별똥별'],
  ['홀로그램','부채춤','파인애플'], ['두꺼비','앵무새','동굴'], ['플라밍고','너구리','동굴'],
  ['드라이기','까치','솥뚜껑'], ['조련사','빨래집게','호루라기'], ['우박','공작','재봉틀'],
  ['허수아비','유람선','풀'], ['아지랑이','짚신','유람선'], ['올챙이','늪지대','바늘'],
  ['청소기','달팽이','거북이'], ['물레방아','귀마개','성벽'], ['버섯','반딧불이','메뚜기'],
  ['귀마개','빙산','인력거'], ['스쿠터','탈춤','필통'], ['윷놀이','고무줄놀이','떡볶이'],
  ['유람선','보온병','곤돌라'], ['두더지','잠자리','빗자루'], ['달팽이','물뿌리개','광부'],
  ['석류','드라이기','여우'], ['간척지','빨래집게','참새'], ['타조','참외','자몽'],
  ['전기밥솥','별똥별','너구리'], ['김밥','가위','광부'], ['알람시계','청소기','짚신'],
  ['쓰레받기','코뿔소','현미경'], ['기린','물레방아','인공위성'], ['앵무새','코뿔소','스쿠터'],
  ['굴렁쇠','장구','두꺼비'], ['호떡','전동휠','마녀'], ['카멜레온','라마','플라밍고'],
  ['망원경','원두막','빙산'], ['악어','하마','사마귀'], ['기린','장갑','우박'],
  ['홀로그램','팽이','부채춤'], ['혜성','도롱이','서리'], ['너구리','손톱깎이','파인애플'],
  ['연날리기','냄비받침','불가사리'], ['손전등','강정','알람시계'], ['시루떡','보온병','돌고래'],
  ['늪지대','두꺼비','열쇠고리'], ['타조','전기밥솥','호떡'], ['저울','짚신','비버'],
  ['습지','풍차','호루라기'], ['연날리기','다람쥐','서리'], ['버섯','기린','혜성'],
  ['공작','우체국','매미'], ['동굴','자몽','악어'], ['제기','사구','타조'],
  ['무지개다리','마녀','증기기관차'], ['습지','열쇠고리','뱁새'], ['케이블카','버섯','순록'],
  ['원두막','코알라','필통'],
];
